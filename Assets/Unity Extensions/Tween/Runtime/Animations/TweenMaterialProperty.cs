        ...
        protected override void OnPropertiesGUI(TweenPlayer player, SerializedProperty property)
        {
            ...
            switch (propertyType)
            {
                ...
                case Type.Range:
                    ...
                    FromToFieldLayout("Value", fromProp.FindPropertyRelative(nameof(Vector4.x)), toProp.FindPropertyRelative(nameof(Vector4.x)),fromDisable);
                    break;

                case Type.Vector:
                    FromToFieldLayout("X", fromProp.FindPropertyRelative(nameof(Vector4.x)), toProp.FindPropertyRelative(nameof(Vector4.x)),fromDisable);
                    FromToFieldLayout("Y", fromProp.FindPropertyRelative(nameof(Vector4.y)), toProp.FindPropertyRelative(nameof(Vector4.y)),fromDisable);
                    FromToFieldLayout("Z", fromProp.FindPropertyRelative(nameof(Vector4.z)), toProp.FindPropertyRelative(nameof(Vector4.z)),fromDisable);
                    FromToFieldLayout("W", fromProp.FindPropertyRelative(nameof(Vector4.w)), toProp.FindPropertyRelative(nameof(Vector4.w)),fromDisable);
                    break;
